...
ActiveRecord::Schema.define(version: 20_201_103_124_536) do
  ...
  create_table 'customers', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index ['purchase_record_id'], name: 'index_customers_on_purchase_record_id'
  end
  ...
  add_foreign_key 'customers', 'purchase_records'
